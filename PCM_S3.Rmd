...
Podemos ahora comparar estos resultados con los de tamaño del genoma aunque recueda que estos, a diferencia de los primeros, están en escala logaritmica.
...
Este modelo introduce un nuevo parámetro llamado alfa (α) que controla la fuerza con la que la partícula se ve atraída hacia ese punto central, al que llamamos theta (θ). Cuanto mayor es alfa, más fuerte es la atracción.
