...
Usa los datos de estimas de porcentage de GC en bacterias ("GC_Content_Percent"). Ajusta los modelos BM, .ambda and OU  con la función fitContinuous y comparalos. Calcula la señal filogenética de este fenotipo con la función phylosig. 
